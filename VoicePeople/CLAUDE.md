# VAST Challenge MC3 Disaster at St. Himark!: Voice from the People
...
- Always ask clarifying questions before starting an analysis.
- Show your methodology and explain what you're looking for.
- Use actual numbers from the data, not vague statements.
- Format all dollar amounts with dollar signs and commas.
- Flag anything unusual or unexpected.
...
- workflows/ -- analysis workflow files
